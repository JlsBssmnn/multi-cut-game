    ...
    <>
      <div className={styles.main}>
        ...
        <p className={styles.description}>
          This game let&apos;s you interactively solve the multicut problem: You
          are given a graph with nodes and edges. Each edge has a cost of either
          -1 (red edge) or 1 (green edge). Nodes connected by green edges want
          to be in the same cluster whereas nodes connected with red edges want
        ...
        <br />
        <Image src={costLocation} alt="current_cost_heighlighted" />
        ...
        <ul className={styles.description}>
          ...
          <li>
            ...
            blink for 3 seconds. If you can&apos;t see the edge despite not
            having reached the optimal solution make sure you can see all edges,
            so no edge is completely overlapping another one. If an edge between
            two nodes in the same cluster blinks it means that these two nodes
          ...
          <li>
            ...
            it&apos;s not trivial to find the optimal solution just from seeing
            this one.
          </li>
        </ul>
        ...
        <p className={styles.description}>
          ...
          manually start the calculation by clicking the &quot;compute
          solution&quot; button. If the solution has been computed you also have
          access to the three buttons described in the previous section.
          <br />
          If you want to start over again you can use the &quot;reset
          graph&quot; button which will reset you multicut to a singleton
          clustering.
          <br />
          If you want to save your level for playing it later or sharing it you
          can press the &quot;download level&quot; button which will download
          the graph and, if computed, the optimal solution. The file can be used
          by going to the Level Import page then clicking on the icon on the
          bottom left and then selecting the downloaded file. If the file
          doesn&apos;t contain an optimal solution the optimal solution will be
          computed when the file is loaded.
        </p>
